...
# Create the `microapplication-webhook` namespace. This cannot be part of the YAML file as we first need to create the TLS secret,
# which would fail otherwise.
echo "Creating Kubernetes objects ..."
kubectl create namespace microapplication-webhook

# Create the TLS secret for the generated keys.
kubectl -n microapplication-webhook create secret tls webhook-server-tls \
